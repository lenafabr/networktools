function [regbound2, boundnodeind2] = intercolatePairsInBoundary(newregbound,boundnodeind,tubeconwidth,minedgelen)
...
newregboundw =[newregbound; newregbound(1,:)]; % wrap around
